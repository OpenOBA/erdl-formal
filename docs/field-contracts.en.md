...
> Basis: [erdl-spec-v2.0](https://github.com/OpenOBA/erdl-landing/blob/main/spec/erdl-spec-v2.0.md) "field contracts" (EntityFieldContract) · this repo's `erdl_formal/field_contracts.py`
