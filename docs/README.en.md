# erdl-formal Documentation Index
...
| Doc | Content |
|---|---|
| `CONTRIBUTING.md` | Contribution flow (issue first, then PR / review / dev environment) |
| `SECURITY.md` | Report vulnerabilities privately (`support@openoba.com`), no public issue |
