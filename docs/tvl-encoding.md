...
> 依据：[erdl-language-spec](https://github.com/OpenOBA/erdl-landing/blob/main/erdl-language-spec-v2.1.md) §7.2 E11/E12
...
本编码采用**叶子折叠**（规范 E11「字段缺失统一返回 false」），**不是 Kleene 传播**。依据（[erdl-language-spec](https://github.com/OpenOBA/erdl-landing/blob/main/erdl-language-spec-v2.1.md) §7.2 E11）：
