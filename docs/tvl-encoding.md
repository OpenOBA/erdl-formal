...
> 依据：[erdl-spec-v2.0](https://github.com/OpenOBA/erdl-landing/blob/main/spec/erdl-spec-v2.0.md) §10.2 E11/E12
...
本编码采用**叶子折叠**（规范 E11「字段缺失统一返回 false」），**不是 Kleene 传播**。依据（[erdl-spec-v2.0](https://github.com/OpenOBA/erdl-landing/blob/main/spec/erdl-spec-v2.0.md) §10.2 E11）：
