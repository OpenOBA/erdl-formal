...
> Basis: [erdl-language-spec](https://github.com/OpenOBA/erdl-landing/blob/main/erdl-language-spec-v2.1.en.md) §5 / §7 · this repo's `tvl.py` / `quantifiers.py` / `fixed_point.py`
